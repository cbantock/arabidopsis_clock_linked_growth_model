...
[T0, Y0] = ode23s(@clock_linked_growth_model, t, yg0, options, 0, params_clock,Temp,Daylength2, mut, param_growth_values);
[T4, Y4] = ode23s(@clock_linked_growth_model, t, yg0, options, 4, params_clock,Temp,Daylength2, mut, param_growth_values);
[T8, Y8] = ode23s(@clock_linked_growth_model, t, yg0, options, 8, params_clock,Temp,Daylength2, mut, param_growth_values);
[T12, Y12] = ode23s(@clock_linked_growth_model, t, yg0, options, 12, params_clock,Temp,Daylength2, mut, param_growth_values);
[T16, Y16] = ode23s(@clock_linked_growth_model, t, yg0, options, 16, params_clock,Temp,Daylength2, mut, param_growth_values);
[T20, Y20] = ode23s(@clock_linked_growth_model, t, yg0, options, 20, params_clock,Temp,Daylength2, mut, param_growth_values);
[T24, Y24] = ode23s(@clock_linked_growth_model, t, yg0, options, 24, params_clock,Temp,Daylength2, mut, param_growth_values);
