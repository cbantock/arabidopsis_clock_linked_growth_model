...
function Func = clock_linked_growth_model_normalized(t,y,light_hours, cE, cC, cEC, params_clock,Temp,Day, mut, params_growth,dusk)
...
%if any(strcmp(mut, 'toc1'))
    
    
%if any(strcmp(mut, 'lhy'))
...
Func(37) = Func(25);
% dPdt
Func(38) = pP/(1+pPE*(y(13)*cEC))-dP*P/(1+kPC*(cC*C))-dPB*P*B;

%dCdt
Func(39) = Func(26) + Func(27);

%dGdt
Func(40) = pG+kG*pGP*P/(1+pGP*P+pGE*(cE*E)+pGB*B+pGH/(1+pHC*(cC*C)));
